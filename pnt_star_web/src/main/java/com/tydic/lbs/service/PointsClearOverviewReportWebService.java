...
@Service("pointsClearOverviewReportService")
public class PointsClearOverviewReportWebService extends BaseService {

    private PointsClearOverviewReportService pointsClearOverviewReportService = (PointsClearOverviewReportService) SpringBeanUtil
            .getBean("pointsClearOverviewReportServiceImpl");
    /**
	 * 获取待清零积分总览报表
	 * 
	 * @param request
	...
	public void getPointExchangeOverviewReportTable(HttpServletRequest request, HttpServletResponse response, Map<String, Object> rtnMap) {
		...
		try {
			String result = pointsClearOverviewReportService.queryPointsClearOverviewReport(json.toJSONString());
	...
	public void exportForm(HttpServletRequest request, HttpServletResponse response, Map<String, Object> rtnMap) {
        ...
        String filePath = "";
        try{
        	filePath = pointsClearOverviewReportService.exportPointsClearOverviewReport(json.toJSONString(), tableTitle, realPath);
        }catch(Exception e){
        	e.printStackTrace();
            rtnMap.put("resultCode", new String("20000"));
