...
CustomProgressbar = function() {
	...
	this.config = {
		...
		showMessage : '<font  style="font-weight:bold;"  color="red">数据加载中，请耐心等待……</font>'
	}
	...
	this.show = function(tData) {
		...
		param.controlObj.prepend('<div id="progressbar_' +param.barId+ '" class="ui-progressbar" '
