//var tableHead = ['区域', '营业区', '月份', '本月可兑换积分', '本月兑换积分', '本月兑换iptv积分', '本月兑换话费积分', '本月兑换流量积分', '本月兑换短信积分', '本月兑换其他礼品积分', '积分兑换率（%）', '达到兑换门限客户数', '本月兑换客户数', '本月兑换iptv客户数', '本月兑换话费客户数', '本月兑换流量客户数', '本月兑换短信客户数', '本月兑换其它礼品客户数', '兑换参与率（%）'];
var table = null;
var tableHead = [
    {
        name: '区域',
...
function queryData(){
    ...
    var param = {
            'serviceName': 'pointExchangeOverviewReportService',
