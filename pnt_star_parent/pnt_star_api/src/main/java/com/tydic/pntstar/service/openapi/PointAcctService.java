...
public interface PointAcctService {
	 ...
	 * @throws Exception
	 */
	@Path("/getPointAcctDetail/pointAcct/{pointAcctId}")
	@GET
//	@Consumes({MediaType.APPLICATION_JSON})	
	 ...
	 * @throws Exception
	 */
	@Path("/insertPointAcct/pointAcct")
	@POST
	@Consumes({MediaType.APPLICATION_JSON})	
	 ...
	 * @throws Exception
	 */
	@Path("/updatePointAcct/pointAcct/{pointAcctId}")
    @PATCH
	@Consumes({MediaType.APPLICATION_JSON})	
	 ...
	 * @throws Exception
	 */
	@Path("/deletePointAcct/pointAcct/{pointAcctId}")
	@DELETE
//	@Consumes({MediaType.APPLICATION_JSON})	
	 ...
	 * @throws Exception
	 */
	@Path("/getPointAcctList/pointAcct")
	@GET
//	@Consumes({MediaType.APPLICATION_JSON})	
