...
public class CommonDBDaoImpl implements CommonDBDao {
	...
	public List<String[]> getSqlList(){
		List<String[]> temps=null;
		temps=this.jct.query("SELECT service_name,flag,sql_desc,sql_desc_add,sql_desc_add2,sql_desc_add3,sql_desc_add4 from par_service_sql_desc_tpss_point order by sql_desc_seq",
					 new RowMapper(){
	...
	public String getPK(String table) {
		...
		param=sqlSession.selectOne("QueryPK",param);
