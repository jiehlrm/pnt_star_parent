...
public class CommonDBDaoImplZW implements CommonDBDaoZW {
	private JdbcTemplate jct;
	private static Logger logger = LoggerFactory
			.getLogger(CommonDBDaoImplZW.class);
	...
	public String getPK(String table) {
		...
		param=sqlSession.selectOne("PayServiceQryPK",param);
